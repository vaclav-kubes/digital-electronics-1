...
normally generate a low output when they are at rest, and a high output only when they are pressed
2. Calculate how many periods of clock signal with frequency of 100&nbsp;MHz contain time intervals 2&nbsp;ms, 4&nbsp;ms, 10&nbsp;ms, 250&nbsp;ms, 500&nbsp;ms, and 1&nbsp;s. Write values in decimal, binary, and hexadecimal forms.

```math
\begin{align}
   T_{clk}=\tfrac{1}{f_{clk}}= \tfrac{1}{100\cdot 10^6}=10 n s\\
  \\
   \textup{number of clk period} = \frac{\textup{time interval}}{T_{clk}}=\tfrac{4\cdot10^{-3}}{10^{-9}}=400000\\
\end{align}
```
<!--
